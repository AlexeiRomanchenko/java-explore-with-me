...
public interface StatRepository extends JpaRepository<Hit, Long> {
    ...
    List<Stat> findUris(List<String> uri, LocalDateTime start, LocalDateTime end);
    ...
    List<Stat> findUrisWithUniqueIp(List<String> uri, LocalDateTime start, LocalDateTime end);
